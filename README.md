...
Добавим в конфигурацию терраформа переменные `docker_disk_size` со значением по умолчанию 10, а так же переменную типа bool `enable_web_traffic` для управления созданием ресурса фаервола.
